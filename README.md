...
Bargain bin is a game where you design the front and back covers of a game that
you found in the bargain bin.

## Preview
The latest build is available [here](http://sketch.unsupported.me).
## Usage
...
Bargain Bin is released under the [MIT License](https://opensource.org/licenses/MIT).
